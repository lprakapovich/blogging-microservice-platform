...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorEnvelope> handleUserNotFoundException(DataIntegrityViolationException e) {
        return buildDefaultResponseEntity(new DuplicatedUsernameException());
    }
